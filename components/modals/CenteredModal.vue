<template>
	<vue-final-modal v-model="show" v-bind="options" content-transition="vfm-fade"
		:content-class="`centered-modal__content centered-modal__content_bg_${props.bgColor}`" class="centered-modal">
