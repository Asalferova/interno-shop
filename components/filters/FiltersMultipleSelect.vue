<template>
  <div
    ref="filter"
    class="filters-multiple-select"
    :class="`filters-multiple-select--${isOpen ? 'opened' : 'closed'}`"
    :tabindex="tabindex"
  ...
  >
    <div class="filters-multiple-select__selected" @click="toggleFilter">
      ...
      <ui-svg
        v-if="props.selectedOptions.length === 0"
        name="arrow"
        class="filters-multiple-select__icon"
      />
      <ui-svg
        v-if="props.selectedOptions.length != 0"
        name="cross"
        class="filters-multiple-select__icon--close"
    ...
    <transition name="dropdown">
      <div v-if="isOpen" class="filters-multiple-select__options">
        <ui-checkbox
          ...
          :key="`filters-multiple-select-option-${i}`"
          v-model="model"
          :value="option"
          multiple
          class="filters-multiple-select__option"
    ...
    <div
      v-if="!props.hasInteractiveLabel && props.selectedOptions.length != 0"
