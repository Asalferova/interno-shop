<template>
	<div ref="filter" class="filters-sort-menu" :class="`filters-sort-menu--${isOpen ? 'opened' : 'closed'}`"
		:tabindex="tabindex" itemprop="additionalType" role="radiogroup">
		...
		<transition name="dropdown">
			<nav v-if="isOpen" class="filters-sort-menu__options">
				<li class="filters-sort-menu__option" v-for="(sort, i) of sorts" :key="`filters-sort-menu-option-${i}`"
					@click="onItemChange(sort)">
					<span class="filters-sort-menu__option--decor" :class="{
