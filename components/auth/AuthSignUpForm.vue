<template>
  <div class="auth-sign-up-form">
    <form class="auth-sign-up-form__form">
      <div class="auth-sign-up-form__group">
        <ui-input
          ...
          :show-error-text="v$.name.$invalid"
          autocomplete="off"
          :placeholder="$t('auth.firstName')"
          class="auth-sign-up-form__input"
          @input="v$.name.$reset"
        ...
        <ui-input
          ...
          :show-error-text="v$.email.$invalid"
          required
          border-radius="big"
          autocomplete="off"
          placeholder="Email"
        ...
        <form-input-password
          ...
          :show-error-text="v$.password.$invalid"
        ...
        <form-input-password
          v-model="authData.repassword"
          required
          :error="repasswordErrorMessage"
          :show-error-text="v$.repassword.$invalid"
    ...
    <div class="auth-sign-up-form__caption text-regular-19-19">
      ...
      <button
        class="auth-sign-up-form__caption-btn"
        @click="emit('change-auth-state', AuthState.SIGN_IN)"
      >
        {{ $t("LogIn") }}
      </button>
    </div>
