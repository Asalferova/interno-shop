<template>
  <div class="main-page-articles">
    <div
      class="main-page-articles__header"
      :class="{ 'main-page-article__header--sort': props.withSort }"
    >
      <div>
    ...
    <div class="main-page-articles__list">
      <template v-if="props.cards?.length && props.type === 'slider'">
        <Swiper
          ...
          :observer="true"
          class="main-page-articles__slider"
          :breakpoints="swiperBreakpoints"
          @swiper="onSwiper"
          @update="onSwiperUpdate"
        >
          <SwiperSlide
            v-for="(item, i) in props.cards"
            :key="`main-page-articles-slide-${i}`"
          >
            <slot name="slide" :item="item" />
          </SwiperSlide>

          <ui-button-next
            class="main-page-articles__slider-control"
            :class="swiperControlClasses.nextEl"
            direction="right"
						aria-hidden="true"
          />
          <ui-button-next
            class="main-page-articles__slider-control"
            :class="swiperControlClasses.prevEl"
            direction="left"
						aria-hidden="true"
          />
        </Swiper>
